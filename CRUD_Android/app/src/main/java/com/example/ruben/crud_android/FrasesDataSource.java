...
/**
 * Created by Ruben on 17/06/2016.
 */
public class FrasesDataSource {
    ...
    public Cursor getFrases_A(String autor){
        //Seleccionamos todas las filas de la tabla Frases, dado un autor.
        String query = "select * from " + FRASES_TABLE_NAME + "WHERE autor=?";
        return database.rawQuery(query, new String[]{""+autor});
    }
